...
if (userInput.usernumber > dynamicNumber){console.log("The entered number is greater than dynamic number value")
}
else if(userInput.usernumber<dynamicNumber){console.log("The entered number is less than dynamic number value")
}
else {console.log("The entered number is equal to dynamic number value");}
...
let schoolName=function(str:string){
    console.log(str);
}
schoolName("Usman public school");
function variable (str:string){
    console.log(str);
}
...
let value1:number=40;
let value2:number=60;
let operator:string= "+";
